...
datacleaning.py → Data preprocessing & visualization

report.py → Automated PDF report generator

Superstore_Report.pdf → Sample output

--> Outcome

Designed a reusable reporting system for business analytics workflows.
